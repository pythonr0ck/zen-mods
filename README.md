...
5. Copy the contents from [preferences.json](https://github.com/pythonr0ck/zen-mods/blob/main/sidebar-expand-on-hover/preferences.json) and [chrome.css](https://github.com/pythonr0ck/zen-mods/blob/main/sidebar-expand-on-hover/chrome.css)
